      ...
      <div className="apply-box" id="punch-holes">
        <div className="apply-border">
          ...
          <div className="apply-text">
            ...
            <p>While we cannot accept everyone, we strive to build a diverse community of amazing hackers. Simply showcase your work, share why you want to attend PennApps, and we will do our best to bring you here! Penn students may register with their Penn emails when applying. Apply now at <a href="https://apply.pennapps.com/">apply.pennapps.com</a>!</p>
            <p></p>
          </div>
        </div>
      </div>
